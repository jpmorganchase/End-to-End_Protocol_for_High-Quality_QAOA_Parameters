...
python benchmark_bobyqa.py -n 12 -p 2 -t budget
python benchmark_bobyqa.py -n 12 -p 3 -t budget
python benchmark_bobyqa.py -n 12 -p 4 -t budget
python benchmark_bobyqa.py -n 12 -p 5 -t budget
