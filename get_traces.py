    ...
    for seed in range(10):
        ...
        for p in range(1,6):
            ...
            # if True:
                ...
                print(f'Completed N={N}, seed={seed}, p={p}, res_AR={rescale_AR:.4f}, X0={X0}, func_call={len(trace_rescaled)}, opt_x={res_rescaled[0]}, res_energy = {res_rescaled[1]:.4f}, time = {rescale_time:.2f}\n')
